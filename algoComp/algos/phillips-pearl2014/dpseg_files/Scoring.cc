...
void
Scoring::add_words_to_lexicon(const Sentence::Words& words, Lexicon& lex)
{
  cforeach(Sentence::Words, iter, words) {
    lex.inc(*iter);
  }
}

void
Scoring::print_results(wostream& os) const
{
  os.precision(4);
  os << "P " << 100*precision()
       << " R " << 100*recall()
...
void
Scoring::print_final_results(wostream& os) const
{
...
void
Scoring::print_segmented_lexicon(wostream& os) const
{
...
void
Scoring::print_reference_lexicon(wostream& os) const
{
...
void
Scoring::print_lexicon(const Lexicon& lexicon, wostream& os) const
{
  /*
...
void
Scoring::print_lexicon_summary(const Lexicon& lexicon, wostream& os) const
{
  /*
  Cs length_counts(Sentence::MAX_LENGTH, 0);
