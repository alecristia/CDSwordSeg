...
python segment.py --algorithms $algo -d ../results/res-providence-CDS/sub$i -g ../recipes/childes/data/Providence/sub$i/gold.txt ../recipes/childes/data/Providence/sub$i/tags.txt
echo sub $i done
done
echo algo $algo done
done
