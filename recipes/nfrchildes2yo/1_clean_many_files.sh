...
INPUT_CORPUS="/fhgfs/bootphon/scratch/acristia/frtest" #where you have put the talkbank corpora to be analyzedE.g. INPUT_CORPUS="/home/xcao/cao/projects/ANR_Alex/Childes_Eng-NA"

#the following will be created
CHA_FOLDER="/fhgfs/bootphon/scratch/acristia/processed_corpora/nfrchildes2yo_cha/" #we will make a copy of all cha files that are considered and put them here E.g. CHA_FOLDER="/home/xcao/cao/projects/ANR_Alex/INPUT_all_cha/"- NOTICE THE / AT THE END OF THE NAME

RES_FOLDER="/fhgfs/bootphon/scratch/acristia/processed_corpora/nfrchildes2yo_res/"	#this is where we will put the processed versions of the transcripts E.g. RES_FOLDER="/home/xcao/cao/projects/ANR_Alex/res_Childes_Eng-NA_cds/" - NOTICE THE / AT THE END OF THE NAME


INPUT_FILES="/fhgfs/bootphon/scratch/acristia/processed_corpora/nfrchildes2yo_info.txt" #E.g INPUT_FILES="/home/xcao/cao/projects/ANR_Alex/res_Childes_Eng-NA_cds/childes_info.txt"
OUTPUT_FILE2="/fhgfs/bootphon/scratch/acristia/processed_corpora/nfrchildes2yo_processedFiles.txt" #E.g. OUTPUT_FILE2="/home/xcao/cao/projects/ANR_Alex/res_Childes_Eng-NA_cds/processed_files.txt"
