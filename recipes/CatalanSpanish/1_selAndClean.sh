...
INPUT_CORPUS="/fhgfs/bootphon/scratch/lfibla/SegCatSpa/corpus_database/trycorpus" #where you have put the talkbank corpora to be analyzedE.g. INPUT_CORPUS="/home/xcao/cao/projects/ANR_Alex/Childes_Eng-NA"

RES_FOLDER="/fhgfs/bootphon/scratch/lfibla/SegCatSpa/Results/RES_corpus/"	#this is where we will put the processed versions of the transcripts E.g. RES_FOLDER="/home/xcao/cao/projects/ANR_Alex/res_Childes_Eng-NA_cds/" - NOTICE THE / AT THE END OF THE NAME
