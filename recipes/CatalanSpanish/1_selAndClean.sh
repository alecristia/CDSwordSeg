...
INPUT_CORPUS="/fhgfs/bootphon/scratch/lfibla/SegCatSpa/corpus_database/spa_mini" #where you have put the talkbank corpora to be analyzedE.g. INPUT_CORPUS="/home/xcao/cao/projects/ANR_Alex/Childes_Eng-NA"
