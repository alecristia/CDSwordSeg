...
PATH_TO_SCRIPTS="/fhgfs/bootphon/scratch/aiturralde/CDSwordSeg/database_creation"	#path to the database_creation folder - E.g. PATH_TO_SCRIPTS="/home/xcao/cao/projects/ANR_Alex/CDSwordSeg/database_creation/"

INPUT_CORPUS="/fhgfs/bootphon/scratch/aiturralde/lscp-ciipme-gh/transcripciones/longi_audio1" #where you have put the talkbank corpora to be analyzedE.g. INPUT_CORPUS="/home/xcao/cao/projects/ANR_Alex/Childes_Eng-NA"
...
INPUT_FILES="/fhgfs/bootphon/scratch/aiturralde/RES_FOLDER/childes_info.txt" #E.g INPUT_FILES="/home/xcao/cao/projects/ANR_Alex/res_Childes_Eng-NA_cds/childes_info.txt"

OUTPUT_FILE2="/fhgfs/bootphon/scratch/aiturralde/RES_FOLDER/processed_files.txt" #E.g. OUTPUT_FILE2="/home/xcao/cao/projects/ANR_Alex/res_Childes_Eng-NA_cds/processed_files.txt"
