...
df_freq_score_algo=read.create_df_freq_all_algo_all_sub(path_res,SUBS,ALGOS,path_to_file_CDI,"/freq-words.txt")
...
data_r2=visualize.plot_algos_CDI_fit_by_age(path_ortho,path_res, SUBS, ALGOS, range(8,19), CDI_file="PropUnderstandCDI.csv", save_file=False, average_algos=False,freq_file="/freq-words.txt",name_visualisation= "CDIScore_AlgoScore")
