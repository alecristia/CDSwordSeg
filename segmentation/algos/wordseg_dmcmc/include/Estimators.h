...
public:
    ...
    virtual bool sanity_check() const
        {
            bool sane = Model::sanity_check();
            sane = sane and _ulex.sanity_check();
            sane = sane and _lex.sanity_check();
            return sane;
        }
...
protected:
    ...
    virtual void find_sent_to_sample(
        U b_to_sample, Sentence& to_sample, Sentences& sentences_seen);
...
{
public:
    BatchBigramViterbi(Data* constants)
        : BatchBigram(constants)
        {}
...
{
public:
    BatchBigramFlipSampler(Data* constants)
        : BatchBigram(constants)
        {}
...
{
public:
    BatchBigramTreeSampler(Data* constants)
        : BatchBigram(constants)
        {}
...
{
public:
    OnlineBigramViterbi(Data* constants)
        : OnlineBigram(constants)
        {}
...
{
public:
    OnlineBigramTreeSampler(Data* constants)
        : OnlineBigram(constants)
        {}
