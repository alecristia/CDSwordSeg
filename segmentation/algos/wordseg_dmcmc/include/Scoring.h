...
//     reference_bs;
//     segmented_bs;
//     Data(): words_correct(0), reference_words(0), segmented_words(0),
// 	    bs_correct(0), reference_bs(0), segmented_bs(0) {}
//   }
  Scoring():
  ...
  void reset();
  void print_results(wostream& os=wcout) const;
  void print_final_results(wostream& os=wcout) const;
  void print_segmented_lexicon(wostream& os=wcout) const;
  void print_reference_lexicon(wostream& os=wcout) const;
  void print_segmentation_summary(wostream& os=wcout) const {
  ...
  void print_lexicon(const Lexicon& lexicon,wostream& os=wcout) const;
  void print_lexicon_summary(const Lexicon& lexicon,wostream& os=wcout) const;
