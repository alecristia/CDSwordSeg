...
//   }
    ...
    void print_segmentation_summary(std::wostream& os=std::wcout) const
        {
            print_lexicon_summary(_segmented_lex, os);
        }
    ...
    void print_lexicon(const Lexicon& lexicon, std::wostream& os=std::wcout) const;

    void print_lexicon_summary(const Lexicon& lexicon, std::wostream& os=std::wcout) const;
